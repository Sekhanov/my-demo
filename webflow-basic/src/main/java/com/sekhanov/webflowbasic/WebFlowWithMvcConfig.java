package com.sekhanov.webflowbasic;
...
public class WebFlowWithMvcConfig extends AbstractFlowConfiguration {
	...
	public FlowDefinitionRegistry flowRegistry() {
		return getFlowDefinitionRegistryBuilder() //
				.setBasePath("classpath:flows") // flow не работает! обязательно flows (ресурс в котором хранятся все )
				.addFlowLocationPattern("/**/*-flow.xml") //classpath:flows/идентификаторпоследовательности(по имени этой папки производтися веб запрос, например /register)/*(любая последовательность букв)-flow.xml
